...
export class Lorikeet {
   ...
   */
  constructor({
    baseURL = readEnv('LORIKEET_BASE_URL'),
    clientID = readEnv('LORIKEET_CLIENT_ID'),
    clientSecret = readEnv('LORIKEET_CLIENT_SECRET'),
    ...opts
  }: ClientOptions = {}) {
    ...
    this.timeout = options.timeout ?? Lorikeet.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('LORIKEET_LOG'), "process.env['LORIKEET_LOG']", this) ??
      defaultLogLevel;
