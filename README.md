...
[![NPM version](<https://img.shields.io/npm/v/@lorikeetai/node-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/@lorikeetai/node-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@lorikeetai/node-sdk)
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install @lorikeetai/node-sdk`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/lorikeet-typescript/issues) with questions, bugs, or suggestions.
