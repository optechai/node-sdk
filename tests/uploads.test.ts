import fs from 'fs';
import type { ResponseLike } from '@lorikeetai/node-sdk/internal/to-file';
import { toFile } from '@lorikeetai/node-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@lorikeetai/node-sdk/core/uploads');
    await expect(
